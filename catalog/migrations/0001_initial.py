    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shippable_date', models.DateField(blank=True, null=True)),
                ('status', models.CharField(blank=True, choices=[('a', 'Available for adoption'), ('n', 'Not available for adoption')], default='a', help_text='Adoption availability', max_length=1)),
            ...
            options={
                ...
                'permissions': (('can_adopt_book', 'can_add_book'),),
            },
        ),
        migrations.AddField(
            model_name='book',
